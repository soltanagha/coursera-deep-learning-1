...
def preProcessing():
    ...
    # Standardize datasets (image pixels between 0->255)
...
def propagate(w, b, X, Y):
    ...
    A = sigmoid(np.dot(np.transpose(w), X)+b) # Activation
...
def main():
    ...
    train_set_x, test_set_x, num_px = preProcessing()
    ...
    plt.title("Learning rate =" +
              str(logistic_regression_model["learning_rate"]))
    plt.show()
